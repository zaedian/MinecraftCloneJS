...
(function (globalScope, statsModuleFactory) {
    ...
    class Stats {
        constructor() {
            ...
            this.fpsPanel = this.addPanel(new Panel("FPS", "#2cc9ff", "#001"));
            this.msPanel = this.addPanel(new Panel("MS", "#2cc9ff", "#001"));

            if (typeof self !== 'undefined' && self.performance && self.performance.memory) {
                this.memoryPanel = this.addPanel(new Panel("MB", "#2cc9ff", "#001"));
            } else {
            ...
            if (this.cpuCores > 0) { // Only add CPU panel if core count is available
                this.cpuPanel = this.addPanel(new Panel(`CPU Threads (${this.cpuCores})`, "#2cc9ff", "#002"));
            } else {
                this.cpuPanel = null;
            }*/
